...
var Daemon = /*#__PURE__*/function () {
  function Daemon() {
    ...
    this.cdcResetDone = this.uploading.pipe((0, _operators.filter)(function (upload) {
      return upload.status === _this.CDC_RESET_DONE;
    }), (0, _operators.first)(), (0, _operators.takeUntil)(this.uploading.pipe((0, _operators.filter)(function (upload) {

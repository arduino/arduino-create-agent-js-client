...
import V2 from './socket-daemon.v2'; // Required agent version
    ...
    value: function findAgent() {
      ...
      if (this.pluginURL) {
        fetch("".concat(this.pluginURL, "/info")).then(function (response) {
          ...
          return timer(POLLING_INTERVAL).subscribe(function () {
...
export { SocketDaemon as default };